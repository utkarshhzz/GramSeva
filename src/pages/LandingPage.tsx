  ...
  return (
    <div className="min-h-screen bg-[#06060a] text-white overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-purple-600/20 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            {/* Hindi tagline */}
            <p className="text-lg md:text-xl text-indigo-300/80 font-medium mb-4">
            ...
            <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
              Report issues, rally your community, and drive real change. AI-powered issue
              classification, voice reporting in your language, and transparent tracking —
              all from your phone.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/sign-up"
                className="group flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 px-8 py-4 rounded-full text-lg font-semibold transition-all hover:shadow-2xl hover:shadow-indigo-500/25 hover:scale-[1.02]"
              >
                Start Reporting
              ...
              <a
                href="#how-it-works"
                className="flex items-center gap-2 px-8 py-4 rounded-full text-lg font-medium text-white/70 hover:text-white border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all"
              >
                See How It Works
              </a>
            </div>
